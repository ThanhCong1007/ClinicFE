...
const Navbar: React.FC<NavbarProps> = ({ onToggleSidebar, onToggleDarkMode, darkMode }) => {
  ...
  const getPageTitle = () => {
    ...
    if (path === '/virtual-reality') return 'Virtual Reality';
    if (path === '/rtl') return 'RTL';
    return 'Dashboard';
  };
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item">
                <Link to="/" className="text-white-50">Pages</Link>
              </li>
