			...
			<div className="container">
				...
				<div className="row g-5 mb-3 px-5">
					...
					<div className="row g-5 mb-2 px-5">
						<div className="col-lg-12 px-5">
							<TextSection title="1. Bảng giá bọc răng sứ mới nhất tại Phòng khám Công Cường">
								<p style={{ fontSize: 18 }}>
									Giá bọc răng sứ tại phòng khám Công Cường dao động từ 1.000.000 – 14.000.000 VNĐ/1 cái.
